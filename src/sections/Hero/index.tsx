...
<section className="container-default h-[auto]" id="hero">
  ...
  <div className="w-full md:w-1/2 flex flex-col gap-6 md:gap-8 hero-1 md:text-left">
      <div className="flex items-center gap-4 md:justify-start">
        <div className="v-bg-highlight h-[2px] w-[54px] rounded" data-aos="fade-up" data-aos-delay="500"></div>
        <h1 className="hidden">Paulo Moraes Advocacia e Consultoria Jurídica</h1>
        <h3 className="text-white text-xl tracking-widest uppercase mulish" data-aos="fade-right" data-aos-delay="500">Paulo Moraes</h3>
      </div>

      <h1 className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif leading-tight playfair" data-aos="fade-down" data-aos-delay="500" >
        Exerça seus direitos.
      </h1>

      <p className="text-white text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mulish" data-aos="fade-up" data-aos-delay="500">
    ...
    <div className="flex flex-col md:flex-row gap-4 md:justify-start">
      <AnimatedButton withDefaultStyles className="v-bg-highlight text-white font-semibold uppercase" data-aos="flip-down" data-aos-delay="500"  onClick={() => {
        const url =
      ...
      <AnimatedButton withDefaultStyles className="border border-white text-white font-semibold uppercase" data-aos="flip-down" data-aos-delay="500">
        Resultados
      </AnimatedButton>
    </div>
    </div>
...
>
    ...
    transition={{
      ...
      backgroundColor: { delay: 0.5, duration: 2 }
    }}
  >
